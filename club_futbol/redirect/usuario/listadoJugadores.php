		...
		<div class="full-width navLateral-body">
            ...
            <nav class="full-width">
                <ul class="full-width list-unstyle menu-principal">
                    <li class="full-width">
                        <a href="/TP6/redirect/usuario/index-usuario.php" class="full-width">
                    ...
                    <li class="full-width">
                        ...
                        <ul class="full-width menu-principal sub-menu-options">
                            ...
                            <li class="full-width">
                                ...
                                <ul class="full-width menu-principal sub-menu-options">
                                    <li class="full-width">
                                        <a href="listadoJugadores.php" class="full-width">
                                            <div class="navLateral-body-cl">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="table-responsive">
										<table id="jugadoresXusuarios" name="jugadoresXusuarios" class="table" style="width:100%">
											<thead>
												<tr>
													<th>Código</th>
													<th>DNI</th>
