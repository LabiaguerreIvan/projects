		...
		<div class="full-width navLateral-body">
			...
			<nav class="full-width">
				<ul class="full-width list-unstyle menu-principal">
					<li class="full-width">
					<a href="/TP6/redirect/empleado/index-empleado.php" class="full-width">
			...
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--12-col">
					<div class="full-width panel mdl-shadow--2dp">
						<div class="full-width panel-tittle  text-center tittles" style="background-color:#fd7e14">
							Nuevo Jugador
						</div>
						<div class="full-width panel-content">
							<form method="POST" action="guardar_ju/guardarJugador.php">
								<!-- INFORMACIÓN BASICA -->
								<div class="mdl-grid">
									<div class="mdl-cell mdl-cell--12-col">
									...
									<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="dni" name="dni">
									...
									<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="apellido" name="apellido">
									...
									<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										...
										<input type="date" class="mdl-textfield__input" id="fecha_nacimiento" name="fecha_nacimiento" required>
															...
															<div class="row">
																<div class="col-lg-12">
																	<div class="table-responsive">
																		<table id="users" name="users" class="table" style="width:100%">
																			<thead>
																				<tr>
																					<th>DNI</th>
																					<th>Nombre</th>
									...
									<div class="mdl-cell mdl-cell--12-col">
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="posicion" name="posicion">
												<?php
												include '../../../conexion.php';
												$sql = "SELECT * from posicion";
												$resultado = mysqli_query($conexion, $sql);
												echo '<option value="-1">Posicion</option>';
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="posicion_alternativa" name="posicion_alternativa">
												<?php
												include '../../../conexion.php';
												$sql = "SELECT * from posicion";
												$resultado = mysqli_query($conexion, $sql);
												echo '<option value="-1">Posicion Alternativa</option>';
												if (mysqli_num_rows($resultado) > 0) {
													while ($registro = mysqli_fetch_array($resultado)) {
														echo '<option value=' . $registro['cod_posicion'] . '>' . $registro['posicion'] . '</option>';
													}
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="pierna_habil" name="pierna_habil">
												<?php
												include '../../../conexion.php';
												...
												echo '<option value="-1">Pierna Hábil</option>';
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="mano_habil" name="mano_habil">
												<?php
												include '../../../conexion.php';
												...
												echo '<option value="-1">Mano Hábil</option>';
												if ($registro = mysqli_num_rows($resultado) > 0) {
													while ($registro = mysqli_fetch_array($resultado)) {
														echo '<option value=' . $registro['cod_extremidad'] . '>' . $registro['desc_extremidad'] . '</option>';
													}
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="estado" name="estado">
												...
												if ($registro = mysqli_num_rows($resultado) > 0) {
													while ($registro = mysqli_fetch_array($resultado)) {
														echo '<option value=' . $registro['cod_estado'] . '>' . $registro['estado'] . '</option>';
													}
												}
												mysqli_close($conexion);
												?>
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="numero_camiseta" name="numero_camiseta" min="1" max="25">
											<label class="mdl-textfield__label" for="numero_camiseta">Numero de
												Camiseta</label>
									...
									<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="telefono_emergencia" name="telefono_emergencia">
									...
									<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="email" id="email_contacto" name="email_contacto">
								...
								<p class="text-center">
									<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-success" id="btn-agregarjugador">
										<i class="fa-solid fa-check" style="color: #ffffff;"></i>
									</button>
								<p class="mdl-tooltip" for="btn-agregarjugador" id="btn-agregarjugador">Agregar Jugador
								</p>
								</p>
							</form>
						</div>
