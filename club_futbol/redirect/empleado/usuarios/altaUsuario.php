		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Módulo de carga - Usuarios</p>
			</div>
		</section>
		<!-- <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect"> -->
		<div class="mdl-tabs__tab-bar">
			<a href="#tabNewProduct" class="mdl-tabs__tab is-active">NUEVO</a>
			<a href="listado_us/listadoUsuarios.php" class="mdl-tabs__tab">LISTADO</a>
		</div>
		<!-- </div> -->
			...
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--12-col">
					<div class="full-width panel mdl-shadow--2dp">
						<div class="full-width panel-tittle  text-center tittles bg-info">
							Nuevo Usuario
						</div>
						<div class="full-width panel-content">
							<form method="POST" action="guardar_us/guardarUsuario.php">
								<!-- INFORMACIÓN BASICA -->
								<div class="mdl-grid">
									<div class="mdl-cell mdl-cell--12-col">
									...
									<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="text" pattern="/^[a-zA-Z-áéíóúÁÉÍÓÚ ]+$/" id="nom_usuario" name="nom_usuario">
									...
									<!-- TIPO USUARIO -->
											...
											<select class="mdl-textfield__input" id="tipo_usuario" name="tipo_usuario">
												...
												if (mysqli_num_rows($resultado) > 0) {
													while ($registro = mysqli_fetch_array($resultado)) {
														echo '<option value=' . $registro['cod_tipo_usuario'] . '>' . $registro['desc_tipo_usuario'] . '</option>';
													}
												}
										...
										<!-- ESTADO -->
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" id="estado_usuario" name="estado_usuario">
												<?php
												include '../../../conexion.php';
												...
												if (mysqli_num_rows($resultado) > 0) {
													while ($registro = mysqli_fetch_array($resultado)) {
														echo '<option value=' . $registro['cod_estado_usuario'] . '>' . $registro['desc_estado_usuario'] . '</option>';
													}
												}
												mysqli_close($conexion);
												?>
								...
								<p class="text-center">
									<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-success" id="btn-guardarUsuario">
										<i class="fa-solid fa-check" style="color: #ffffff;"></i>
									</button>
								<p class="mdl-tooltip" for="btn-guardarUsuario" id="btn-guardarUsuario">Guardar Usuario
								</p>
								</p>
							</form>
						</div>
