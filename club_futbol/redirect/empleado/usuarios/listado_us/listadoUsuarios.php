		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Tabla de registros - Usuarios</p>
			</div>
		</section>
		<div class="mdl-tabs__tab-bar">
			<a href="../altaUsuario.php" class="mdl-tabs__tab">NUEVO</a>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="table-responsive">
										<table id="usersEdit" name="usersEdit" class="table" style="width:100%">
											<thead>
												<tr>
													<th>Código</th>
													<th>DNI</th>
